...
const Footer: React.FC = () => {
  return (
    <footer className="py-8 px-6 shadow-inner overflow-hidden" style={{ background: 'linear-gradient(90deg, #3A86FF 0%, #5F6CAF 100%)', color: 'white' }}>
      {/* Decorative curved top edge */}
      <div className="absolute left-0 right-0 top-0 w-full h-8 pointer-events-none z-20">
        <svg viewBox="0 0 100 10" preserveAspectRatio="none" className="w-full h-full">
          <path d="M0,10 Q50,-10 100,10 L100,0 L0,0 Z" fill="url(#footerGradient)" />
          <defs>
