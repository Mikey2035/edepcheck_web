...
const Header: React.FC = () => {
  ...
  return (
    <header className="relative z-50 flex justify-between items-center h-20 px-6 overflow-hidden" style={{ background: 'linear-gradient(90deg, #3A86FF 0%, #5F6CAF 100%)' }}>
      {/* Logo without Animated Bubbles */}
      <Link href="/" className="flex items-center gap-3 cursor-pointer z-10 h-full" style={{paddingTop: 0, paddingBottom: 0}}>
        <Image src="/images/Brainicon.png" alt="Logo" width={44} height={44} style={{objectFit: 'contain', display: 'block', marginTop: 2, marginBottom: 2}} />
