            ...
            <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
                  ...
                  {severity === "Mild depression" && (
                    <>
                      ...
                      <p>
                        ...
                        connect with loved ones, exercise, and practice
                        mindfulness. Seek support if symptoms persist.
                      </p>
                    </>
                  )}
                  {severity === "Moderate depression" && (
                    <>
                      ...
                      <p>
                        ...
                        social withdrawal, trouble sleeping, and difficulty
                        focusing.
                      </p>
                      <p>
                        <strong>What to do:</strong> Consider counseling or a
                        support group. Early intervention helps.
                      </p>
                    </>
                  )}
                  {severity === "Moderately severe depression" && (
                    <>
                      ...
                      <p>
                        ...
                        hopelessness, appetite/sleep changes, and possible
                        thoughts of self-harm.
                      </p>
                      <p>
                        <strong>What to do:</strong> Seek help from a mental
                        health professional. Therapy can help you recover.
                      </p>
                    </>
                  )}
                  {severity === "Severe depression" && (
                    <>
                      ...
                      <p>
                        ...
                        isolation, fatigue, feelings of worthlessness, and
                        suicidal thoughts.
                      </p>
                      <p>
                        <strong>What to do:</strong> Seek immediate professional
                        help. Contact a crisis line or clinic as soon as
                        possible.
                      </p>
                    </>
                  )}
              ...
              {[
                ...
                <div className="mt-6 text-sm text-blue-700">
                  <p className="font-semibold mb-2">Recommended Support:</p>
