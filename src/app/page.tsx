          ...
          <div className="w-full max-w-md">
            <div className="relative w-full flex justify-center items-center mb-4">
              ...
              <style jsx>{`
                ...
                @keyframes bubble12 {
                  0% { transform: translateY(0) scale(1); }
                  50% { transform: translateY(-8px) scale(1.17); }
                  100% { transform: translateY(0) scale(1); }
                }
                .animate-bubble1 { animation: bubble1 2.5s infinite ease-in-out; }
                .animate-bubble2 { animation: bubble2 2.2s infinite ease-in-out; }
                .animate-bubble3 { animation: bubble3 2.8s infinite ease-in-out; }
                .animate-bubble4 { animation: bubble4 3.1s infinite ease-in-out; }
                .animate-bubble5 { animation: bubble5 2.7s infinite ease-in-out; }
                .animate-bubble6 { animation: bubble6 2.3s infinite ease-in-out; }
                .animate-bubble7 { animation: bubble7 2.9s infinite ease-in-out; }
                .animate-bubble8 { animation: bubble8 2.6s infinite ease-in-out; }
                .animate-bubble9 { animation: bubble9 2.4s infinite ease-in-out; }
                .animate-bubble10 { animation: bubble10 2.8s infinite ease-in-out; }
                .animate-bubble11 { animation: bubble11 2.5s infinite ease-in-out; }
                .animate-bubble12 { animation: bubble12 2.7s infinite ease-in-out; }
              `}</style>
            </div>
